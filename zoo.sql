...
grant all privileges on Animal_Carers to public;
...
grant all privileges on Zones to public;
...
grant all privileges on Animal_BasicInfo to public;
...
grant all privileges on Animal_Diet to public;
...
grant all privileges on Take_Care_Of to public;
...
grant all privileges on Supply_Managers to public;
...
grant all privileges on Manage to public;
...
grant all privileges on Company to public;
...
grant all privileges on Location_Method to public;
...
grant all privileges on Animal_Hospitals to public;
...
grant all privileges on Vets_Occupation to public;
